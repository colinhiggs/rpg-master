...
Teaching the toolset to find rulesets in a layout like that — an
environment variable, or a small config file listing where to look — is
the obvious next extension, and a good first test of everything above.
